...
__ALIGN_BEGIN uint8_t USBD_MIDI_CfgDesc[USB_MIDI_CONFIG_DESC_SIZ] __ALIGN_END = {
    ...
    0x01,
    0x01,
    0x00,  // MIDI-IN 1 (embedded)
    0x06,
    0x24,
    0x02,
    0x02,
    0x02,
    0x00,  // MIDI-IN 1 (external)
    ...
    0x01,
    0x11,
    0x00,  // MIDI-IN 2 (embedded)
    0x06,
    0x24,
    0x02,
    0x02,
    0x12,
    0x00,  // MIDI-IN 2 (external)
...
static uint8_t USBD_MIDI_DataOut(USBD_HandleTypeDef* pdev, uint8_t epnum)
{
    ...
    pmidi = (USBD_MIDI_ItfTypeDef*)(pdev->pUserData[0]);
